...
export function ImageUploader({imageUrl, onFieldChange, setFiles}){
    ...
    return (
        <div {...getRootProps()} className="flex-center flex h-72 cursor-pointer flex-col overflow-hidden rounded-md bg-gray-50">
            ...
            {imageUrl? (
                ...
                <div className="flex-col text-center pt-12 border-dashed border-2 border-gray-300 rounded-md h-full">
                    ...
                    <p className="p-medium-12 mb-4">.png or .jpeg extensions</p>
                    <button type="button" className="btn btn-secondary btn-rounded btn-sm">Select From Computer</button>
